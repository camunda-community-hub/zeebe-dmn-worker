# Contributing to Zeebe-DMN-Worker
...
a [new issue](https://github.com/camunda-community-hub/zeebe-dmn-worker/issues). Before creating an issue, make sure
...
a [new issue](https://github.com/camunda-community-hub/zeebe-dmn-worker/issues). Describe your idea and the
...
```
feat(worker): evaluate DMN 1.4 decisions

* supporting new DMN 1.4 
* ...
```
